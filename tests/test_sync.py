...
def test_load_csv(tmp_path):
    ...
    content = "CODIGO_INTERNO,DESCRIPCION,UNIDAD,CODIGO_BARRAS,COSTO,PRECIO_VENTA,EXISTENCIA\n"
    content += "1,PROD 1,UND,123,10,20,5\n"
    content += "2,PROD 2,UND,456,15,30,10\n"
...
def test_sync_incremental_no_changes(mocker):
    ...
    mocker.patch("sync._save_metadata")

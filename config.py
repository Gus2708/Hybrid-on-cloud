...
SUPABASE_URL = os.environ.get("SUPABASE_URL", "https://rgniqjfooifchyctnbzu.supabase.co")
...
SUPABASE_REST_URL = os.environ.get("SUPABASE_REST_URL", "https://rgniqjfooifchyctnbzu.supabase.co")
SUPABASE_ANON_KEY = os.environ.get(
    "SUPABASE_ANON_KEY",
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9."
    "eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJnbmlxamZvb2lmY2h5Y3RuYnp1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzc4NDI2NTUsImV4cCI6MjA5MzQxODY1NX0."
    "MwhE9n5DjbWNN42Qsj-yNmF_sSlOWZbf4mXJy2NUnKQ"
)
